  ...
  return (
    <main className='h-screen flex justify-center items-center bg-lightBlue'>
      <section className='h-screen bg-lightBlue lg:h-fit lg:flex lg:flex-row lg:gap-10 p-3 rounded-xl lg:bg-white text-white'>
        <article className='fixed top-0 left-0 z-0 w-full flex flex-row justify-center bg-sidebarMobile bg-cover gap-4 py-8 h-[180px] lg:px-8 lg:py-10 lg:static lg:flex-col lg:justify-start lg:bg-sidebarDesktop lg:h-[565px] lg:w-[270px] lg:rounded-xl'>
          <CurrentStep />
        </article>
